...
_dokku_cli_completions() {
    ...
    local commands="setup list create destroy info logs logs:follow config config:set config:unset restart start stop scale shell deploy rollback releases lock unlock lock:status ssl domains db run help version"
